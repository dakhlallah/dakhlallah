<!-- Profile README for github.com/dakhlallah -->
...
| --- | --- |
| **AI products** | Assistants that understand context, make decisions, and stay human in the loop |
...
- Dry-run simulation, signed webhooks, duplicate protection, cost caps, and watchdog recovery are built in.
...
<p>
  <img src="https://skillicons.dev/icons?i=python,ts,js,swift,react,nextjs,html,css,nodejs,figma,github&perline=11" alt="Technology stack" />
</p>
